/**
 * EJEMPLO ACTUALIZADO: Login.tsx con soporte para CourierSync y MFA
 * 
 * Este archivo muestra cómo implementar el login con soporte para MFA.
...
import { Rol, rolStringToNumber } from '@/types/backend';
...
const Login = () => {
  ...
  // Si requiere MFA, mostrar formulario de código MFA
  if (requiresMfa) {
    return (
